...
This copy is authoritative for this repo. Do not summarise, compress or adapt it here — when
the source changes, every consuming repo is re-imported in the same change.
